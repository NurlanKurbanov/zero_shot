...
# driver.get("https://www.woman.ru/search/?q=%D0%BE%D0%BA%D1%80&where=forum&category=&sort=relevance&control_charset=0")
...
# #print(data)
#
# with open('okr_url.txt', 'w') as file:
...
urls = []
with open('okr_url.txt', 'r') as file0:
    for line in file0:
        line = line.replace('\\', '/')
        line = line.strip()
        urls.append(line)
...
with open('okr_text.txt', 'a') as file:
    writer = csv.writer(file, lineterminator='\n')
