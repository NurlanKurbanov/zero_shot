...
# driver.get("https://www.woman.ru/search/?q=%D1%80%D0%BF%D0%BF&where=forum_threads&sort=relevance&control_charset=0&category=")
...
# #print(data)
#
# with open('rpp_url.txt', 'w') as file:
...
urls = []
with open('rpp_url.txt', 'r') as file0:
    for line in file0:
        line = line.replace('\\', '/')
        line = line.strip()
        urls.append(line)
...
with open('rpp_text.txt', 'a') as file:
    writer = csv.writer(file, lineterminator='\n')
